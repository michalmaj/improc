...
########## GLOBAL TARGET PROPERTIES Debug ########################################
    ...
    set_property(TARGET libaom-av1::libaom-av1
                 ...
                 $<$<CONFIG:Debug>:${libaom-av1_LINKER_FLAGS_DEBUG}>)
    set_property(TARGET libaom-av1::libaom-av1
                 APPEND PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                 $<$<CONFIG:Debug>:${libaom-av1_INCLUDE_DIRS_DEBUG}>)
    # Necessary to find LINK shared libraries in Linux
    set_property(TARGET libaom-av1::libaom-av1
                 APPEND PROPERTY INTERFACE_LINK_DIRECTORIES
                 $<$<CONFIG:Debug>:${libaom-av1_LIB_DIRS_DEBUG}>)
    set_property(TARGET libaom-av1::libaom-av1
                 APPEND PROPERTY INTERFACE_COMPILE_DEFINITIONS
                 $<$<CONFIG:Debug>:${libaom-av1_COMPILE_DEFINITIONS_DEBUG}>)
    set_property(TARGET libaom-av1::libaom-av1
                 APPEND PROPERTY INTERFACE_COMPILE_OPTIONS
                 $<$<CONFIG:Debug>:${libaom-av1_COMPILE_OPTIONS_DEBUG}>)
